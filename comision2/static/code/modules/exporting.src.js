        ...
        extend(Chart.prototype, /** @lends Highcharts.Chart.prototype */ {
            ...
            getSVG: function (chartOptions) {
                ...
                each(chart.axes, function (axis) {
                    ...
                    if (axisCopy && (
                            (userMin !== undefined && userMin !== axisCopy.min) || (userMax !== undefined && userMax !== axisCopy.max))) {
            ...
            getSVGForExport: function (options, chartOptions) {
                ...
                return this.getSVG(merge({
                    ...
                    exporting: {
                        sourceWidth: (
                            (options && options.sourceWidth) || chartExportingOptions.sourceWidth),
                        sourceHeight: (
                            (options && options.sourceHeight) || chartExportingOptions.sourceHeight)
                    }
                }));
            },
            /**
